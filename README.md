...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,352 | 🐛 182 | 🌐 Python | 📅 2026-09-01 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,167 | 🐛 151 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,526 | 🐛 137 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,788 | 🐛 85 | 🌐 TypeScript | 📅 2026-09-03 - Official Stripe tooling and MCP server for building AI-powered payment agents.
* [PayPal Agent Toolkit](https://github.com/paypal/agent-toolkit) ⭐ 190 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-01 - Official PayPal toolkit for integrating commerce actions into AI agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 738 | 🐛 152 | 🌐 TypeScript | 📅 2026-09-03 - Command-line tool for building apps, themes and extensions.
...
* [Dawn](https://github.com/Shopify/dawn) ⭐ 3,064 | 🐛 22 | 🌐 Liquid | 📅 2026-08-10 - Shopify's reference Online Store 2.0 theme.
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,109 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-03 - Shopify's React framework for building custom headless storefronts.
* [Liquid](https://shopify.github.io/liquid/) - Open-source template language created by Shopify.

### Apps & Extensions

* [Shopify App Template (Remix)](https://github.com/Shopify/shopify-app-template-remix) ⭐ 557 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-05 - Official starter template for building Shopify apps with Remix.
...
* [Shopify shop-chat-agent](https://github.com/Shopify/shop-chat-agent) ⭐ 142 | 🐛 37 | 🌐 JavaScript | 📅 2026-06-09 - Reference Shopify app embedding an AI chat widget for product discovery and checkout via MCP.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,116 | 🐛 204 | 🌐 TypeScript | 📅 2026-09-03 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,089 | 🐛 38 | 🌐 PHP | 📅 2026-09-03 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,287 | 🐛 246 | 🌐 Python | 📅 2026-09-02 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,663 | 🐛 135 | 🌐 Ruby | 📅 2026-09-03 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,395 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-03 - Headless open-source commerce framework for Node.js.
...
* [Next.js Commerce](https://github.com/vercel/commerce) ⭐ 14,241 | 🐛 79 | 🌐 TypeScript | 📅 2026-08-13 - High-performance headless commerce storefront starter.
...
* [Storefront UI](https://github.com/vuestorefront/storefront-ui) ⭐ 2,508 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-02 - Component library for building fast ecommerce storefronts.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 93,916 | 🐛 3,786 | 📅 2026-09-01 - A curated list of Model Context Protocol servers.
