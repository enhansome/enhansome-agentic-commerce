...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,389 | 🐛 211 | 🌐 Python | 📅 2026-09-24 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,190 | 🐛 161 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,546 | 🐛 142 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,830 | 🐛 93 | 🌐 TypeScript | 📅 2026-09-24 - Official Stripe tooling and MCP server for building AI-powered payment agents.
* [PayPal Agent Toolkit](https://github.com/paypal/agent-toolkit) ⭐ 194 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - Official PayPal toolkit for integrating commerce actions into AI agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 751 | 🐛 155 | 🌐 TypeScript | 📅 2026-09-24 - Command-line tool for building apps, themes and extensions.
...
* [Dawn](https://github.com/Shopify/dawn) ⭐ 3,089 | 🐛 33 | 🌐 Liquid | 📅 2026-08-10 - Shopify's reference Online Store 2.0 theme.
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,134 | 🐛 108 | 🌐 TypeScript | 📅 2026-09-24 - Shopify's React framework for building custom headless storefronts.
* [Liquid](https://shopify.github.io/liquid/) - Open-source template language created by Shopify.

### Apps & Extensions

* [Shopify App Template (Remix)](https://github.com/Shopify/shopify-app-template-remix) ⭐ 559 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-05 - Official starter template for building Shopify apps with Remix.
...
* [Shopify shop-chat-agent](https://github.com/Shopify/shop-chat-agent) ⭐ 150 | 🐛 39 | 🌐 JavaScript | 📅 2026-09-23 - Reference Shopify app embedding an AI chat widget for product discovery and checkout via MCP.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,443 | 🐛 192 | 🌐 TypeScript | 📅 2026-09-24 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,167 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,370 | 🐛 280 | 🌐 Python | 📅 2026-09-24 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,718 | 🐛 161 | 🌐 Ruby | 📅 2026-09-24 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,469 | 🐛 239 | 🌐 TypeScript | 📅 2026-09-22 - Headless open-source commerce framework for Node.js.
...
* [Next.js Commerce](https://github.com/vercel/commerce) ⭐ 14,277 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-13 - High-performance headless commerce storefront starter.
* [Vue Storefront (Alokai)](https://github.com/vuestorefront/vue-storefront) ⭐ 10,952 | 🐛 52 | 📅 2026-06-09 - Frontend platform for headless commerce.
* [Storefront UI](https://github.com/vuestorefront/storefront-ui) ⭐ 2,678 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-04 - Component library for building fast ecommerce storefronts.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,479 | 🐛 2,298 | 📅 2026-09-23 - A curated list of Model Context Protocol servers.
* [awesome-shopify](https://github.com/julionc/awesome-shopify) ⭐ 1,281 | 🐛 7 | 📅 2026-09-14 - A curated list of Shopify resources and open-source projects.
