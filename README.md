# Awesome Agentic Commerce with stars
...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,382 | 🐛 210 | 🌐 Python | 📅 2026-09-19 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,183 | 🐛 161 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,546 | 🐛 141 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,830 | 🐛 91 | 🌐 TypeScript | 📅 2026-09-20 - Official Stripe tooling and MCP server for building AI-powered payment agents.
* [PayPal Agent Toolkit](https://github.com/paypal/agent-toolkit) ⭐ 193 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-01 - Official PayPal toolkit for integrating commerce actions into AI agents.
...
* [shopify-api-js](https://github.com/Shopify/shopify-api-js) ⚠️ Archived - Official Shopify API client library for Node.js.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 750 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-20 - Command-line tool for building apps, themes and extensions.
...
* [Dawn](https://github.com/Shopify/dawn) ⭐ 3,083 | 🐛 27 | 🌐 Liquid | 📅 2026-08-10 - Shopify's reference Online Store 2.0 theme.
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,131 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-18 - Shopify's React framework for building custom headless storefronts.
* [Liquid](https://shopify.github.io/liquid/) - Open-source template language created by Shopify.

### Apps & Extensions

* [Shopify App Template (Remix)](https://github.com/Shopify/shopify-app-template-remix) ⭐ 556 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-05 - Official starter template for building Shopify apps with Remix.
...
* [Shopify shop-chat-agent](https://github.com/Shopify/shop-chat-agent) ⭐ 149 | 🐛 37 | 🌐 JavaScript | 📅 2026-06-09 - Reference Shopify app embedding an AI chat widget for product discovery and checkout via MCP.
...
* [woocommerce-rest-api-js-lib](https://github.com/woocommerce/woocommerce-rest-api-js-lib) ⭐ 304 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-19 - Official JavaScript client for the WooCommerce REST API.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,388 | 🐛 195 | 🌐 TypeScript | 📅 2026-09-20 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,137 | 🐛 23 | 🌐 PHP | 📅 2026-09-18 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,350 | 🐛 273 | 🌐 Python | 📅 2026-09-18 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,713 | 🐛 156 | 🌐 Ruby | 📅 2026-09-20 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,457 | 🐛 228 | 🌐 TypeScript | 📅 2026-09-18 - Headless open-source commerce framework for Node.js.
...
* [Next.js Commerce](https://github.com/vercel/commerce) ⭐ 14,269 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-13 - High-performance headless commerce storefront starter.
* [Vue Storefront (Alokai)](https://github.com/vuestorefront/vue-storefront) ⭐ 10,944 | 🐛 52 | 📅 2026-06-09 - Frontend platform for headless commerce.
* [Storefront UI](https://github.com/vuestorefront/storefront-ui) ⭐ 2,511 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-04 - Component library for building fast ecommerce storefronts.
...
* [Ecommerce AI Visibility Engine](https://github.com/MentionNetwork/ecommerce-ai-visibility-engine) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-08 - Open-source engine measuring how AI assistants recommend your store and products, ranked against competing retailers.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,310 | 🐛 2,332 | 📅 2026-09-15 - A curated list of Model Context Protocol servers.
* [awesome-shopify](https://github.com/julionc/awesome-shopify) ⭐ 1,278 | 🐛 7 | 📅 2026-09-14 - A curated list of Shopify resources and open-source projects.
