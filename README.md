...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,380 | 🐛 195 | 🌐 Python | 📅 2026-09-16 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,180 | 🐛 159 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,822 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-17 - Official Stripe tooling and MCP server for building AI-powered payment agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 746 | 🐛 151 | 🌐 TypeScript | 📅 2026-09-17 - Command-line tool for building apps, themes and extensions.
...
* [Dawn](https://github.com/Shopify/dawn) ⭐ 3,080 | 🐛 28 | 🌐 Liquid | 📅 2026-08-10 - Shopify's reference Online Store 2.0 theme.
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,128 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-16 - Shopify's React framework for building custom headless storefronts.
...
* [woocommerce-rest-api-js-lib](https://github.com/woocommerce/woocommerce-rest-api-js-lib) ⭐ 304 | 🐛 69 | 🌐 JavaScript | 📅 2026-09-04 - Official JavaScript client for the WooCommerce REST API.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,347 | 🐛 186 | 🌐 TypeScript | 📅 2026-09-17 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,122 | 🐛 22 | 🌐 PHP | 📅 2026-09-17 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,339 | 🐛 272 | 🌐 Python | 📅 2026-09-17 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,696 | 🐛 152 | 🌐 Ruby | 📅 2026-09-17 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,443 | 🐛 229 | 🌐 TypeScript | 📅 2026-09-17 - Headless open-source commerce framework for Node.js.
...
* [Next.js Commerce](https://github.com/vercel/commerce) ⭐ 14,264 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-13 - High-performance headless commerce storefront starter.
* [Vue Storefront (Alokai)](https://github.com/vuestorefront/vue-storefront) ⭐ 10,942 | 🐛 52 | 📅 2026-06-09 - Frontend platform for headless commerce.
* [Storefront UI](https://github.com/vuestorefront/storefront-ui) ⭐ 2,511 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-04 - Component library for building fast ecommerce storefronts.
...
* [Ecommerce AI Visibility Engine](https://github.com/MentionNetwork/ecommerce-ai-visibility-engine) ⭐ 1 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-08 - Open-source engine measuring how AI assistants recommend your store and products, ranked against competing retailers.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,118 | 🐛 2,205 | 📅 2026-09-15 - A curated list of Model Context Protocol servers.
* [awesome-shopify](https://github.com/julionc/awesome-shopify) ⭐ 1,276 | 🐛 6 | 📅 2026-09-14 - A curated list of Shopify resources and open-source projects.
