...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,323 | 🐛 169 | 🌐 Python | 📅 2026-08-21 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,146 | 🐛 143 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,517 | 🐛 136 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,755 | 🐛 75 | 🌐 TypeScript | 📅 2026-08-21 - Official Stripe tooling and MCP server for building AI-powered payment agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 732 | 🐛 126 | 🌐 TypeScript | 📅 2026-08-21 - Command-line tool for building apps, themes and extensions.
...
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,094 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-21 - Shopify's React framework for building custom headless storefronts.
...
* [woocommerce-rest-api-js-lib](https://github.com/woocommerce/woocommerce-rest-api-js-lib) ⭐ 304 | 🐛 69 | 🌐 JavaScript | 📅 2026-08-12 - Official JavaScript client for the WooCommerce REST API.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 35,929 | 🐛 166 | 🌐 TypeScript | 📅 2026-08-21 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 27,987 | 🐛 28 | 🌐 PHP | 📅 2026-08-20 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,247 | 🐛 246 | 🌐 Python | 📅 2026-08-20 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,631 | 🐛 134 | 🌐 Ruby | 📅 2026-08-21 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,357 | 🐛 191 | 🌐 TypeScript | 📅 2026-08-21 - Headless open-source commerce framework for Node.js.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,631 | 🐛 3,271 | 📅 2026-08-17 - A curated list of Model Context Protocol servers.
