...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,390 | 🐛 209 | 🌐 Python | 📅 2026-09-25 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,192 | 🐛 161 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,547 | 🐛 144 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,831 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-25 - Official Stripe tooling and MCP server for building AI-powered payment agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 751 | 🐛 160 | 🌐 TypeScript | 📅 2026-09-25 - Command-line tool for building apps, themes and extensions.
...
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,134 | 🐛 111 | 🌐 TypeScript | 📅 2026-09-25 - Shopify's React framework for building custom headless storefronts.
...
* [Shopify shop-chat-agent](https://github.com/Shopify/shop-chat-agent) ⭐ 150 | 🐛 40 | 🌐 JavaScript | 📅 2026-09-23 - Reference Shopify app embedding an AI chat widget for product discovery and checkout via MCP.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,459 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-25 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,168 | 🐛 25 | 🌐 PHP | 📅 2026-09-23 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,375 | 🐛 282 | 🌐 Python | 📅 2026-09-24 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,720 | 🐛 165 | 🌐 Ruby | 📅 2026-09-25 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,473 | 🐛 239 | 🌐 TypeScript | 📅 2026-09-25 - Headless open-source commerce framework for Node.js.
...
* [Storefront UI](https://github.com/vuestorefront/storefront-ui) ⭐ 2,696 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-04 - Component library for building fast ecommerce storefronts.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,504 | 🐛 2,358 | 📅 2026-09-23 - A curated list of Model Context Protocol servers.
