...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,339 | 🐛 168 | 🌐 Python | 📅 2026-08-28 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,160 | 🐛 147 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,524 | 🐛 136 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,774 | 🐛 82 | 🌐 TypeScript | 📅 2026-08-29 - Official Stripe tooling and MCP server for building AI-powered payment agents.
* [PayPal Agent Toolkit](https://github.com/paypal/agent-toolkit) ⭐ 189 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-20 - Official PayPal toolkit for integrating commerce actions into AI agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 735 | 🐛 155 | 🌐 TypeScript | 📅 2026-08-29 - Command-line tool for building apps, themes and extensions.
...
* [Dawn](https://github.com/Shopify/dawn) ⭐ 3,061 | 🐛 20 | 🌐 Liquid | 📅 2026-08-10 - Shopify's reference Online Store 2.0 theme.
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,105 | 🐛 70 | 🌐 TypeScript | 📅 2026-08-28 - Shopify's React framework for building custom headless storefronts.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,046 | 🐛 189 | 🌐 TypeScript | 📅 2026-08-28 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,032 | 🐛 31 | 🌐 PHP | 📅 2026-08-27 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,274 | 🐛 245 | 🌐 Python | 📅 2026-08-28 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,652 | 🐛 134 | 🌐 Ruby | 📅 2026-08-28 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,381 | 🐛 206 | 🌐 TypeScript | 📅 2026-08-28 - Headless open-source commerce framework for Node.js.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 93,010 | 🐛 3,712 | 📅 2026-08-27 - A curated list of Model Context Protocol servers.
