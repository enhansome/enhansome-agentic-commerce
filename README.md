...
* [UCP Specification](https://github.com/Universal-Commerce-Protocol/ucp) ⭐ 3,368 | 🐛 191 | 🌐 Python | 📅 2026-09-10 - Reference specification and documentation for UCP, released under Apache 2.0.
* [AP2 Specification](https://github.com/google-agentic-commerce/AP2) ⭐ 3,176 | 🐛 157 | 🌐 Python | 📅 2026-06-17 - Reference specification and implementation for AP2, backed by 60+ payment partners.
* [ACP Specification](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol) ⭐ 1,541 | 🐛 139 | 🌐 JavaScript | 📅 2026-07-18 - Reference specification, schemas and product-feed spec for ACP.
...
* [Stripe AI Toolkit](https://github.com/stripe/ai) ⭐ 1,799 | 🐛 87 | 🌐 TypeScript | 📅 2026-09-11 - Official Stripe tooling and MCP server for building AI-powered payment agents.
...
* [Shopify CLI](https://github.com/Shopify/cli) ⭐ 743 | 🐛 158 | 🌐 TypeScript | 📅 2026-09-11 - Command-line tool for building apps, themes and extensions.
...
* [Hydrogen](https://github.com/Shopify/hydrogen) ⭐ 2,124 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-11 - Shopify's React framework for building custom headless storefronts.
...
* [Medusa](https://github.com/medusajs/medusa) ⭐ 36,262 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-11 - Composable, open-source commerce engine built with Node.js.
* [Bagisto](https://github.com/bagisto/bagisto) ⭐ 28,111 | 🐛 23 | 🌐 PHP | 📅 2026-09-12 - Open-source Laravel ecommerce platform.
* [Saleor](https://github.com/saleor/saleor) ⭐ 23,321 | 🐛 262 | 🌐 Python | 📅 2026-09-11 - GraphQL-first, open-source ecommerce platform.
* [Spree](https://github.com/spree/spree) ⭐ 15,690 | 🐛 144 | 🌐 Ruby | 📅 2026-09-12 - Open-source Ruby on Rails ecommerce platform.
* [Vendure](https://github.com/vendurehq/vendure) ⭐ 8,428 | 🐛 227 | 🌐 TypeScript | 📅 2026-09-11 - Headless open-source commerce framework for Node.js.
...
* [Next.js Commerce](https://github.com/vercel/commerce) ⭐ 14,255 | 🐛 80 | 🌐 TypeScript | 📅 2026-08-13 - High-performance headless commerce storefront starter.
...
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 94,837 | 🐛 2,393 | 📅 2026-09-08 - A curated list of Model Context Protocol servers.
* [awesome-shopify](https://github.com/julionc/awesome-shopify) ⭐ 1,274 | 🐛 5 | 📅 2026-09-10 - A curated list of Shopify resources and open-source projects.
